...
settings.preselectedCorpora = ['lanchart_lanchart_bornholm', 'lanchart_lanchart_bylderup'];

settings.corporafolders.lanchart = {
    title : "LANCHART-korpusset",
    contents : ['lanchart_lanchart_bornholm', 'lanchart_lanchart_bylderup'],
...
settings.lanchartCustomAttrs = {
    ...
    file_cust : {
        ...
        customType : "struct",
        // TODO: This should be done using Angular in order to enable translations of each attribute label.
        pattern : '<%=struct_attrs.text_filename%> <p style="margin-left: 10px; margin-bottom: 5px">Dato: <%=struct_attrs.text_dato || "?"%>, Generation: <%=struct_attrs.text_generation || "?"%>, Gammel/ny: <%=struct_attrs.text_oldnew || "?"%>, Samtaletype: <%=struct_attrs.text_samtaletype || "?"%>, Projekt: <%=struct_attrs.text_name || "?"%>, Samtalelængde: <%=struct_attrs.text_textduration || "?"%></p>'
    },
    turn_cust : {
        label : "turn_custom",
        order : 2,
        customType : "struct",
        // TODO: This should be done using Angular in order to enable translations of each attribute label.
        pattern : '<%=struct_attrs.turn_turnummer%>, Længde: <%=struct_attrs.turn_turnduration || "?"%> <p style="margin-left: 10px; margin-bottom: 5px">Start: <%=struct_attrs.turn_turnmin || "?"%>, Slut: <%=struct_attrs.turn_turnmax || "?"%></p>'
    },
    partitur_cust : {
...
var lanchart_talekilde = { label: "talekilde",
    order: 4 };
var lanchart_name1 = { label: "name1",
    order: 5 };
...
settings.corpora.lanchart_bornholm = {
    ...
    structAttributes : {
        ...
        turn_talekilde : lanchart_talekilde,
...
settings.corpora.lanchart_bylderup = {
    ...
    title : "Bylderup",
    description : "Korpus af udskrifterne fra Bylderup-projektet",
    within : {"turn": "turn"}, //defaultWithin,
    context : {"1 turn": "1 turn"}, //defaultContext,
    attributes : {
        ipa : lanchart_ipa,
